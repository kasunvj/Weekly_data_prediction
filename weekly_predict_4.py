...
in1 =np.zeros((1,1),float)
print("previouse Val:",worksheet.cell(row_count,0).value)
in1[0][0] = worksheet.cell(row_count,0).value
in1 =scaler.fit_transform(in1)
in1  = np.reshape(in1,(in1.shape[0],1,in1.shape[1]))
day_prediction =int(scaler.inverse_transform(model.predict(in1)))
print("new Prediction:",day_prediction)
