...
look_back = 15
week_predictions =[]
output_averaging = np.zeros((8,7), dtype= float)
itter =0;
...
for iteration in range (0,8):
    for day in range(0,7):
        ...
        output_averaging[iteration][day] = int(actualPredict)
...
print(output_averaging)
print("weeks_trained: ",np.shape(raw_dataset))
